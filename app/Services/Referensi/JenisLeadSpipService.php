...
use App\Repositories\Eloquent\Referensi\JenisLeadSpipRepository;
use App\Traits\ResponseTransform;
use App\Traits\SlugHeaderRequest;
use DB;
use Illuminate\Support\Collection;

class JenisLeadSpipService
{
     ...
     * constructor.
     *
     * @param JenisLeadSpipRepository $repository
     */
    public function __construct(
        protected JenisLeadSpipRepository $repository = new JenisLeadSpipRepository(),
    ) {
    }
