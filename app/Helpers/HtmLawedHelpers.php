...
if (! function_exists('htmLawed')) {
    function htmLawed($t, $C = 1, $S = [])
    {
        ...
        if (! empty($C['valid_xhtml'])) {
            ...
            $C['make_tag_strict'] = $C['make_tag_strict'] ?? 2;
            $C['xml:lang'] = $C['xml:lang'] ?? 2;
        }
        // config eles
        ...
        $C['anti_mail_spam'] = $C['anti_mail_spam'] ?? 0;
        ...
        if ($C['clean_ms_char']) {
            ...
            $x += ($C['clean_ms_char'] === 1 ? ["\x82" => '&#8218;', "\x84" => '&#8222;', "\x91" => '&#8216;', "\x92" => '&#8217;', "\x93" => '&#8220;', "\x94" => '&#8221;'] : ["\x82" => '\'', "\x84" => '"', "\x91" => '\'', "\x92" => '\'', "\x93" => '"', "\x94" => '"']);
            $t = strtr($t, $x);
        }
