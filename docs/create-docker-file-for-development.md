...
|------------------|----------------------|------------------------------------------------------------------------| ------------ | ------------ |
| Octane (default) | `app.dev`            | [supervisord.app.dev.conf](deployment/octane/supervisord.app.conf)     | Swoole | 9000 |
| Octane (prod)    | `app`                | [supervisord.app.conf](deployment/octane/supervisord.app.conf)         | Swoole | 9000 |
...
- Swoole HTTP server config for development in `supervisord.app.dev.conf` (include autoreload using chokidar)
